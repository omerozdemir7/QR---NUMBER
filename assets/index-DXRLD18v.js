 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eS{constructor(){this.counters_={}}incrementCounter(e,n=1){Ut(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=n}get(){return Zw(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aa={},ua={};function bc(t){const e=t.toString();return aa[e]||(aa[e]=new eS),aa[e]}function tS(t,e){const n=t.toString();return ua[n]||(ua[n]=e()),ua[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DS(t,e){return $r(t.name,e.name)}function Wc(t,e){return $r(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Xg,Jg;function MS(t){Xg=t}function bS(t){Jg=t}class FS extends gl{compare(e,n){const r=e.node.getPriority(),i=n.node.getPriority(),s=r.compareTo(i);return s===0?$r(e.name,n.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return L.MIN}maxPost(){return new L(Bn,new ce("[PRIORITY-POST]",Jg))}makePost(e,n){const r=Xg(e);return new L(n,new ce("[PRIORITY-POST]",r))}toString(){return".priority"}}const te=new FS;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const US=Math.log(2);class zS{constructor(e){const n=s=>parseInt(Math.log(s)/US,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Mo=function(t,e,n,r){t.sort(e);const i=function(a,u){const h=u-a;let d,c;if(h===0)return null;if(h===1)return d=t[a],c=n?n(d):d,new he(c,d.node,he.BLACK,null,null);{const g=parseInt(h/2,10)+a,_=i(a,g),y=i(g+1,u);return d=t[g],c=n?n(d):d,new he(c,d.node,he.BLACK,_,y)}},s=function(a){let u=null,h=null,d=t.length;const c=function(_,y){const P=d-_,p=d;d-=_;const f=i(P+1,p),m=t[P],v=n?n(m):m;g(new he(v,m.node,y,null,f))},g=function(_){u?(u.left=_,u=_):(h=_,u=_)};for(let _=0;_<a.count;++_){const y=a.nextBitIsOne(),P=Math.pow(2,a.count-(_+1));y?c(P,he.BLACK):(c(P,he.BLACK),c(P,he.RED))}return h},o=new zS(t.length),l=s(o);return new De(r||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BS=!0;function ge(t,e=null){if(t===null)return A.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),E(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new ce(n,ge(e))}if(!(t instanceof Array)&&BS){const n=[];let r=!1;if(Ue(t,(o,l)=>{if(o.substring(0,1)!=="."){const a=ge(l);a.isEmpty()||(r=r||!a.getPriority().isEmpty(),n.push(new L(o,a)))}}),n.length===0)return A.EMPTY_NODE;const s=Mo(n,DS,o=>o.name,Wc);if(r){const o=Mo(n,te.getCompare());return new A(s,ge(e),new It({".priority":o},{".priority":te}))}else return new A(s,ge(e),It.Default)}else{let n=A.EMPTY_NODE;return Ue(t,(r,i)=>{if(Ut(t,r)&&r.substring(0,1)!=="."){const s=ge(i);(s.isLeafNode()||!s.isEmpty())&&(n=n.updateImmediateChild(r,s))}}),n.updatePriority(ge(e))}}MS(ge);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HS extends gl{compare(e,n){const r=e.node.compareTo(n.node);return r===0?$r(e.name,n.name):r}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return L.MIN}maxPost(){return L.MAX}makePost(e,n){const r=ge(e);return new L(n,r)}toString(){return".value"}}const jS=new HS;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qS{constructor(){this.rootNode_=A.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,n){this.rootNode_=this.rootNode_.updateChild(e,n)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class YS{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n={...e};return this.last_&&Ue(this.last_,(r,i)=>{n[r]=n[r]-i}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const af=10*1e3,XS=30*1e3,JS=5*60*1e3;class ZS{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new YS(e);const r=af+(XS-af)*Math.random();Ri(this.reportStats_.bind(this),Math.floor(r))}reportStats_(){const e=this.statsListener_.get(),n={};let r=!1;Ue(e,(i,s)=>{s>0&&Ut(this.statsToReport_,i)&&(n[i]=s,r=!0)}),r&&this.server_.reportStats(n),Ri(this.reportStats_.bind(this),Math.floor(Math.random()*2*JS))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class e0{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function t0(t,e,n,r){const i=[],s=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&s.push($S(o.childName,o.snapshotNode))}),ui(t,i,"child_removed",e,r,n),ui(t,i,"child_added",e,r,n),ui(t,i,"child_moved",s,r,n),ui(t,i,"child_changed",e,r,n),ui(t,i,"value",e,r,n),i}function ui(t,e,n,r,i,s){const o=r.filter(l=>l.type===n);o.sort((l,a)=>r0(t,l,a)),o.forEach(l=>{const a=n0(t,l,s);i.forEach(u=>{u.respondsTo(l.type)&&e.push(u.createEvent(a,t.query_))})})}function n0(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function r0(t,e,n){if(e.childName==null||n.childName==null)throw Br("Should only compare child_ events.");const r=new L(e.childName,e.snapshotNode),i=new L(n.childName,n.snapshotNode);return t.index_.compare(r,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $c(t,e){return l_(e,t)}function s0(t,e,n,r,i){E(r>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:r,visible:i}),i&&(t.visibleWrites=Pi(t.visibleWrites,e,n)),t.lastWriteId=r}function o0(t,e){for(let n=0;n<t.allWrites.length;n++){const r=t.allWrites[n];if(r.writeId===e)return r}return null}function l0(t,e){const n=t.allWrites.findIndex(l=>l.writeId===e);E(n>=0,"removeWrite called with nonexistent writeId.");const r=t.allWrites[n];t.allWrites.splice(n,1);let i=r.visible,s=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const l=t.allWrites[o];l.visible&&(o>=n&&a0(l,r.path)?i=!1:st(r.path,l.path)&&(s=!0)),o--}if(i){if(s)return u0(t),!0;if(r.snap)t.visibleWrites=cf(t.visibleWrites,r.path);else{const l=r.children;Ue(l,a=>{t.visibleWrites=cf(t.visibleWrites,le(r.path,a))})}return!0}else return!1}function a0(t,e){if(t.snap)return st(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&st(le(t.path,n),e))return!0;return!1}function u0(t){t.visibleWrites=i_(t.allWrites,c0,W()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function c0(t){return t.visible}function i_(t,e,n){let r=ct.empty();for(let i=0;i<t.length;++i){const s=t[i];if(e(s)){const o=s.path;let l;if(s.snap)st(n,o)?(l=Oe(n,o),r=Pi(r,l,s.snap)):st(o,n)&&(l=Oe(o,n),r=Pi(r,W(),s.snap.getChild(l)));else if(s.children){if(st(n,o))l=Oe(n,o),r=uf(r,l,s.children);else if(st(o,n))if(l=Oe(o,n),M(l))r=uf(r,W(),s.children);else{const a=xr(s.children,D(l));if(a){const u=a.getChild(j(l));r=Pi(r,W(),u)}}}else throw Br("WriteRecord should have .snap or .children")}}return r}function s_(t,e,n,r,i){if(!r&&!i){const s=qn(t.visibleWrites,e);if(s!=null)return s;{const o=un(t.visibleWrites,e);if(Su(o))return n;if(n==null&&!Cu(o,W()))return null;{const l=n||A.EMPTY_NODE;return Mr(o,l)}}}else{const s=un(t.visibleWrites,e);if(!i&&Su(s))return n;if(!i&&n==null&&!Cu(s,W()))return null;{const o=function(u){return(u.visible||i)&&(!r||!~r.indexOf(u.writeId))&&(st(u.path,e)||st(e,u.path))},l=i_(t.allWrites,o,e),a=n||A.EMPTY_NODE;return Mr(l,a)}}}function d0(t,e,n){let r=A.EMPTY_NODE;const i=qn(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(te,(s,o)=>{r=r.updateImmediateChild(s,o)}),r;if(n){const s=un(t.visibleWrites,e);return n.forEachChild(te,(o,l)=>{const a=Mr(un(s,new H(o)),l);r=r.updateImmediateChild(o,a)}),df(s).forEach(o=>{r=r.updateImmediateChild(o.name,o.node)}),r}else{const s=un(t.visibleWrites,e);return df(s).forEach(o=>{r=r.updateImmediateChild(o.name,o.node)}),r}}function h0(t,e,n,r,i){E(r||i,"Either existingEventSnap or existingServerSnap must exist");const s=le(e,n);if(Cu(t.visibleWrites,s))return null;{const o=un(t.visibleWrites,s);return Su(o)?i.getChild(n):Mr(o,i.getChild(n))}}function f0(t,e,n,r){const i=le(e,n),s=qn(t.visibleWrites,i);if(s!=null)return s;if(r.isCompleteForChild(n)){const o=un(t.visibleWrites,i);return Mr(o,r.getNode().getImmediateChild(n))}else return null}function p0(t,e){return qn(t.visibleWrites,e)}function m0(t,e,n,r,i,s,o){let l;const a=un(t.visibleWrites,e),u=qn(a,W());if(u!=null)l=u;else if(n!=null)l=Mr(a,n);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const h=[],d=o.getCompare(),c=s?l.getReverseIteratorFrom(r,o):l.getIteratorFrom(r,o);let g=c.getNext();for(;g&&h.length<i;)d(g,r)!==0&&h.push(g),g=c.getNext();return h}else return[]}function g0(){return{visibleWrites:ct.empty(),allWrites:[],lastWriteId:-1}}function zo(t,e,n,r){return s_(t.writeTree,t.treePath,e,n,r)}function Gc(t,e){return d0(t.writeTree,t.treePath,e)}function hf(t,e,n,r){return h0(t.writeTree,t.treePath,e,n,r)}function Wo(t,e){return p0(t.writeTree,le(t.treePath,e))}function _0(t,e,n,r,i,s){return m0(t.writeTree,t.treePath,e,n,r,i,s)}function Kc(t,e,n){return f0(t.writeTree,t.treePath,e,n)}function o_(t,e){return l_(le(t.treePath,e),t.writeTree)}function l_(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class y0{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,r=e.childName;E(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),E(r!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(r);if(i){const s=i.type;if(n==="child_added"&&s==="child_removed")this.changeMap.set(r,Zi(r,e.snapshotNode,i.snapshotNode));else if(n==="child_removed"&&s==="child_added")this.changeMap.delete(r);else if(n==="child_removed"&&s==="child_changed")this.changeMap.set(r,Ji(r,i.oldSnap));else if(n==="child_changed"&&s==="child_added")this.changeMap.set(r,Lr(r,e.snapshotNode));else if(n==="child_changed"&&s==="child_changed")this.changeMap.set(r,Zi(r,e.snapshotNode,i.oldSnap));else throw Br("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(r,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class v0{getCompleteChild(e){return null}getChildAfterChild(e,n,r){return null}}const a_=new v0;class qc{constructor(e,n,r=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=r}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const r=this.optCompleteServerCache_!=null?new Hn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Kc(this.writes_,e,r)}}getChildAfterChild(e,n,r){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:jn(this.viewCache_),s=_0(this.writes_,i,n,1,r,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Vo;class D0{constructor(){this.views=new Map}}function L0(t){E(!Vo,"__referenceConstructor has already been defined"),Vo=t}function M0(){return E(Vo,"Reference.ts has not been loaded"),Vo}function b0(t){return t.views.size===0}function Qc(t,e,n,r){const i=e.source.queryId;if(i!==null){const s=t.views.get(i);return E(s!=null,"SyncTree gave us an op for an invalid query."),_f(s,e,n,r)}else{let s=[];for(const o of t.views.values())s=s.concat(_f(o,e,n,r));return s}}function F0(t,e,n,r,i){const s=e._queryIdentifier,o=t.views.get(s);if(!o){let l=zo(n,i?r:null),a=!1;l?a=!0:r instanceof A?(l=Gc(n,r),a=!1):(l=A.EMPTY_NODE,a=!1);const u=_l(new Hn(l,a,!1),new Hn(r,i,!1));return new N0(e,u)}return o}function U0(t,e,n,r,i,s){const o=F0(t,e,r,i,s);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),x0(o,n),O0(o,n)}function z0(t,e,n,r){const i=e._queryIdentifier,s=[];let o=[];const l=pn(t);if(i==="default")for(const[a,u]of t.views.entries())o=o.concat(gf(u,n,r)),mf(u)&&(t.views.delete(a),u.query._queryParams.loadsAllData()||s.push(u.query));else{const a=t.views.get(i);a&&(o=o.concat(gf(a,n,r)),mf(a)&&(t.views.delete(i),a.query._queryParams.loadsAllData()||s.push(a.query)))}return l&&!pn(t)&&s.push(new(M0())(e._repo,e._path)),{removed:s,events:o}}function d_(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function wr(t,e){let n=null;for(const r of t.views.values())n=n||A0(r,e);return n}function h_(t,e){if(e._queryParams.loadsAllData())return yl(t);{const r=e._queryIdentifier;return t.views.get(r)}}function f_(t,e){return h_(t,e)!=null}function pn(t){return yl(t)!=null}function yl(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ho;function W0(t){E(!Ho,"__referenceConstructor has already been defined"),Ho=t}function B0(){return E(Ho,"Reference.ts has not been loaded"),Ho}let V0=1;class yf{constructor(e){this.listenProvider_=e,this.syncPointTree_=new K(null),this.pendingWriteTree_=g0(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function p_(t,e,n,r,i){return s0(t.pendingWriteTree_,e,n,r,i),i?ps(t,new Vn(t_(),e,n)):[]}function xn(t,e,n=!1){const r=o0(t.pendingWriteTree_,e);if(l0(t.pendingWriteTree_,e)){let s=new K(null);return r.snap!=null?s=s.set(W(),!0):Ue(r.children,o=>{s=s.set(new H(o),!0)}),ps(t,new Uo(r.path,s,n))}else return[]}function vl(t,e,n){return ps(t,new Vn(Hc(),e,n))}function H0(t,e,n){const r=K.fromObject(n);return ps(t,new ns(Hc(),e,r))}function j0(t,e){return ps(t,new ts(Hc(),e))}function $0(t,e,n){const r=Xc(t,n);if(r){const i=Jc(r),s=i.path,o=i.queryId,l=Oe(s,e),a=new ts(jc(o),l);return Zc(t,s,a)}else return[]}function Tu(t,e,n,r,i=!1){const s=e._path,o=t.syncPointTree_.get(s);let l=[];if(o&&(e._queryIdentifier==="default"||f_(o,e))){const a=z0(o,e,n,r);b0(o)&&(t.syncPointTree_=t.syncPointTree_.remove(s));const u=a.removed;if(l=a.events,!i){const h=u.findIndex(c=>c._queryParams.loadsAllData())!==-1,d=t.syncPointTree_.findOnPath(s,(c,g)=>pn(g));if(h&&!d){const c=t.syncPointTree_.subtree(s);if(!c.isEmpty()){const g=q0(c);for(let _=0;_<g.length;++_){const y=g[_],P=y.query,p=__(t,y);t.listenProvider_.startListening(Ai(P),jo(t,P),p.hashFn,p.onComplete)}}}!d&&u.length>0&&!r&&(h?t.listenProvider_.stopListening(Ai(e),null):u.forEach(c=>{const g=t.queryToTagMap.get(wl(c));t.listenProvider_.stopListening(Ai(c),g)}))}Q0(t,u)}return l}function G0(t,e,n,r){const i=Xc(t,r);if(i!=null){const s=Jc(i),o=s.path,l=s.queryId,a=Oe(o,e),u=new Vn(jc(l),a,n);return Zc(t,o,u)}else return[]}function K0(t,e,n,r){const i=Xc(t,r);if(i){const s=Jc(i),o=s.path,l=s.queryId,a=Oe(o,e),u=K.fromObject(n),h=new ns(jc(l),a,u);return Zc(t,o,h)}else return[]}function vf(t,e,n,r=!1){const i=e._path;let s=null,o=!1;t.syncPointTree_.foreachOnPath(i,(c,g)=>{const _=Oe(c,i);s=s||wr(g,_),o=o||pn(g)});let l=t.syncPointTree_.get(i);l?(o=o||pn(l),s=s||wr(l,W())):(l=new D0,t.syncPointTree_=t.syncPointTree_.set(i,l));let a;s!=null?a=!0:(a=!1,s=A.EMPTY_NODE,t.syncPointTree_.subtree(i).foreachChild((g,_)=>{const y=wr(_,W());y&&(s=s.updateImmediateChild(g,y))}));const u=f_(l,e);if(!u&&!e._queryParams.loadsAllData()){const c=wl(e);E(!t.queryToTagMap.has(c),"View does not exist, but we have a tag");const g=Y0();t.queryToTagMap.set(c,g),t.tagToQueryMap.set(g,c)}const h=$c(t.pendingWriteTree_,i);let d=U0(l,e,n,h,s,a);if(!u&&!o&&!r){const c=h_(l,e);d=d.concat(X0(t,e,c))}return d}function Yc(t,e,n){const i=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,l)=>{const a=Oe(o,e),u=wr(l,a);if(u)return u});return s_(i,e,s,n,!0)}function ps(t,e){return m_(e,t.syncPointTree_,null,$c(t.pendingWriteTree_,W()))}function m_(t,e,n,r){if(M(t.path))return g_(t,e,n,r);{const i=e.get(W());n==null&&i!=null&&(n=wr(i,W()));let s=[];const o=D(t.path),l=t.operationForChild(o),a=e.children.get(o);if(a&&l){const u=n?n.getImmediateChild(o):null,h=o_(r,o);s=s.concat(m_(l,a,u,h))}return i&&(s=s.concat(Qc(i,t,r,n))),s}}function g_(t,e,n,r){const i=e.get(W());n==null&&i!=null&&(n=wr(i,W()));let s=[];return e.children.inorderTraversal((o,l)=>{const a=n?n.getImmediateChild(o):null,u=o_(r,o),h=t.operationForChild(o);h&&(s=s.concat(g_(h,l,a,u)))}),i&&(s=s.concat(Qc(i,t,r,n))),s}function __(t,e){const n=e.query,r=jo(t,n);return{hashFn:()=>(P0(e)||A.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return r?$0(t,n._path,r):j0(t,n._path);{const s=GC(i,n);return Tu(t,n,null,s)}}}}function jo(t,e){const n=wl(e);return t.queryToTagMap.get(n)}function wl(t){return t._path.toString()+"$"+t._queryIdentifier}function Xc(t,e){return t.tagToQueryMap.get(e)}function Jc(t){const e=t.indexOf("$");return E(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new H(t.substr(0,e))}}function Zc(t,e,n){const r=t.syncPointTree_.get(e);E(r,"Missing sync point for query tag that we're tracking");const i=$c(t.pendingWriteTree_,e);return Qc(r,n,i,null)}function q0(t){return t.fold((e,n,r)=>{if(n&&pn(n))return[yl(n)];{let i=[];return n&&(i=d_(n)),Ue(r,(s,o)=>{i=i.concat(o)}),i}})}function Ai(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(B0())(t._repo,t._path):t}function Q0(t,e){for(let n=0;n<e.length;++n){const r=e[n];if(!r._queryParams.loadsAllData()){const i=wl(r),s=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(s)}}}function Y0(){return V0++}function X0(t,e,n){const r=e._path,i=jo(t,e),s=__(t,n),o=t.listenProvider_.startListening(Ai(e),i,s.hashFn,s.onComplete),l=t.syncPointTree_.subtree(r);if(i)E(!pn(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((u,h,d)=>{if(!M(u)&&h&&pn(h))return[yl(h).query];{let c=[];return h&&(c=c.concat(d_(h).map(g=>g.query))),Ue(d,(g,_)=>{c=c.concat(_)}),c}});for(let u=0;u<a.length;++u){const h=a[u];t.listenProvider_.stopListening(Ai(h),jo(t,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
